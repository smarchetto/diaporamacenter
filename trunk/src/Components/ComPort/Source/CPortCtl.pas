...
type
  ...
  public
    ...
    property ComPort: TBaseComPort read FComPort write FComPort;
  ...
  published
    property ComPort: TBaseComPort read GetComPort write SetComPort;
...
procedure TComComboBox.SetComPort(const Value: TBaseComPort);
begin
...
function TComComboBox.GetComPort: TBaseComPort;
begin
...
// set ComPort property
procedure TComRadioGroup.SetComPort(const Value: TBaseComPort);
begin
  if FComSelect.ComPort <> Value then
  begin
    FComSelect.ComPort := Value;
...
function TComRadioGroup.GetComPort: TBaseComPort;
begin
  Result := FComSelect.ComPort;
end;
